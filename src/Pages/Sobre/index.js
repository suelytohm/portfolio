    ...
    <section className="sobre" id="sobre">
      ...
      <div className="textos">
        ...
        <p>
          ...
          decorrer da minha vida profissional, eu realizei projetos utilizando
          Javascript/Typescript, Python, NodeJS, React, React Native. Eu tenho
          experiência, no consumo de APIs RESTful, na criação de chatbots para
          WhatsApp, na coleta de dados da Web, com bibliotecas para NodeJS, nas
          automações com Python. Já utilizei os bancos de dados MySQL,
